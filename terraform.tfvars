...
ssh_key_name = "dayal-ssh"             #name of ssh key to be created in SoftLayer
ssh_user = "root"                   #OS username
icpadmin_password = "Rat1onal" #ICP admin password
icp_version = "3.1.1"             #ICP Version
...
heketi_admin_pwd = "Rat1onal"  #Heketi API admin password
